...
### Bob Delegates to Dummy Service

<!-- TODO -->

### Dummy Service Invokes Cloud Storage

<!-- TODO create capabilityInvocation proof -->
...
Show:
* Bob delegates to Dummy Service
* Dummy Service creates invocation of `UploadFile`
* Dummy Service delivers invocation to `invocationTarget` at Cloud Storage
